...
a = Analysis(
    ...
    datas=[
        ...
        ('setting_interface.py', '.'),  # Include setting_interface.py in the root of the dist folder
...
exe = EXE(
    ...
    icon=get_resource_path('_internal/resource/icon.ico')  # Specify your icon file here
)
coll = COLLECT(
    exe,
    a.binaries,
